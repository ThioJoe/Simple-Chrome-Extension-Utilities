...
## [Gemini Code Block Bottom Copy Button (Obsolete)](Gemini%20Code%20Block%20Bottom%20Copy%20Button/)
> **⚠️ Note:** This extension is now largely obsolete, as Google has officially added a native copy button to the bottom of code blocks on Gemini.
